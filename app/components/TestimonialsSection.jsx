...
import reviewBg from '~/assets/review-bg.svg?url';
...
export default function TestimonialsSection() {
  ...
  return (
    <section className="relative w-full min-h-screen py-8 sm:py-12 md:py-16 px-4 overflow-hidden flex items-center">
      {/* Background SVG */}
      <div
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full">
        ...
        <div className="text-center mb-8 sm:mb-12 md:mb-16">
          ...
          <div className="flex items-center justify-center gap-2 sm:gap-4 mb-3 sm:mb-4">
            <img
              ...
              width={20}
              height={20}
              className="opacity-70 w-4 h-4 sm:w-6 sm:h-6"
            />
          ...
          {/* Subtitle */}
          <p className="text-gray-700 text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed max-w-4xl mx-auto px-4">
            Join the growing family of kawaii lovers! See why customers rave
            about our giant cat plushie and adorable collection.
          </p>
        </div>
          ...
          <div className="relative w-full overflow-hidden">
            ...
            >
              {infiniteTestimonials.map((testimonial, index) => (
                ...
                >
                  <div className="bg-white/90 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg border border-pink-100 relative h-full">
                    {/* Quote Icon */}
        ...
        <div className="flex justify-center">
          <Button href="/reviews" variant="primary" size="medium">
