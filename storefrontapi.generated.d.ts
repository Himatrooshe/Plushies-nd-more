...
export type SpecialPricesProductFragment = Pick<
  StorefrontAPI.Product,
  'id' | 'title' | 'handle' | 'availableForSale'
> & {
  priceRange: {
...
export type SpecialPricesProductsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type SpecialPricesProductsQuery = {
  products: {
    nodes: Array<
      Pick<
        StorefrontAPI.Product,
...
export type CollectionListItemFragment = Pick<
  StorefrontAPI.Collection,
  'id' | 'title' | 'handle'
>;
...
export type StoreCollectionsAllQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  first: StorefrontAPI.Scalars['Int']['input'];
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type StoreCollectionsAllQuery = {
  collections: {
    nodes: Array<
      Pick<
        StorefrontAPI.Collection,
...
export type RelatedProductImageFragment = Pick<
  StorefrontAPI.Image,
  'id' | 'url' | 'altText' | 'width' | 'height'
>;
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  fragment SpecialPricesProduct on Product {\n    id\n    title\n    handle\n    availableForSale\n    priceRange {\n      minVariantPrice {\n        amount\n        currencyCode\n      }\n    }\n    featuredImage {\n      id\n      url\n      altText\n      width\n      height\n    }\n    variants(first: 1) {\n      nodes {\n        id\n        availableForSale\n      }\n    }\n  }\n  query SpecialPricesProducts($country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    products(first: 8, sortKey: TITLE) {\n      nodes {\n        ...SpecialPricesProduct\n      }\n    }\n  }\n': {
    return: SpecialPricesProductsQuery;
    variables: SpecialPricesProductsQueryVariables;
  };
  ...
  '#graphql\n  fragment Collection on Collection {\n    id\n    title\n    handle\n    description\n    image {\n      id\n      url\n      altText\n      width\n      height\n    }\n  }\n  query StoreCollectionsAll(\n    $country: CountryCode\n    $first: Int!\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    collections(first: $first) {\n      nodes {\n        ...Collection\n      }\n    }\n  }\n': {
    return: StoreCollectionsAllQuery;
    variables: StoreCollectionsAllQueryVariables;
  };
  '#graphql\n  query Page(\n    $language: LanguageCode,\n    $country: CountryCode,\n    $handle: String!\n  )\n  @inContext(language: $language, country: $country) {\n    page(handle: $handle) {\n      handle\n      id\n      title\n      body\n      seo {\n        description\n        title\n      }\n    }\n  }\n': {
    return: PageQuery;
